...
local shiftMod  = "SUPER+SHIFT" -- Sets "Windows + Shift" key as shift modifier
...
hl.bind(mainMod .. " + V", hl.dsp.layout("centerwindow"))
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd(menu))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + T", hl.dsp.layout("togglesplit"))    -- dwindle only
hl.bind(mainMod .. " + F", hl.dsp.layout("fullscreen", 1))
hl.bind(mainMod .. " + F11", hl.dsp.layout("fullscreen", 0))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/wallpaper-selector.sh"))
